...
func _make_card(data: Dictionary) -> CardData:
	...
	card.excluded_characters = data.get("excluded", [])
...
func _register_shared_cards() -> void:
	_make_card({"id": &"m01", "name": "ナイフスラッシュ", "desc": "6ダメージ", "ap": 1, "tags": [CardData.Tag.MELEE], "damage": 6, "up_damage": 9})
	_make_card({"id": &"m02", "name": "ヘビーブロー", "desc": "12ダメージ", "ap": 2, "tags": [CardData.Tag.MELEE], "damage": 12, "up_damage": 18})
	_make_card({"id": &"m03", "name": "チェーン切り", "desc": "4ダメージ×2", "ap": 1, "tags": [CardData.Tag.MELEE], "rarity": CardData.Rarity.UNCOMMON, "damage": 4, "hits": 2, "up_damage": 6})
	_make_card({"id": &"m07", "name": "カウンターナイフ", "desc": "4ブロック+4ダメージ", "ap": 1, "tags": [CardData.Tag.MELEE], "rarity": CardData.Rarity.UNCOMMON, "damage": 4, "block": 4, "up_damage": 6, "up_block": 6})
	_make_card({"id": &"r01", "name": "ピストルショット", "desc": "6ダメージ", "ap": 1, "tags": [CardData.Tag.RANGED], "damage": 6, "up_damage": 9, "excluded": [CardData.CharacterRestriction.CONQUEROR]})
	_make_card({"id": &"r02", "name": "ショットガンブラスト", "desc": "全体4ダメージ", "ap": 2, "tags": [CardData.Tag.RANGED], "damage": 4, "aoe": true, "up_damage": 6, "excluded": [CardData.CharacterRestriction.CONQUEROR]})
	_make_card({"id": &"r03", "name": "ヘッドショット", "desc": "14ダメージ", "ap": 2, "tags": [CardData.Tag.RANGED], "rarity": CardData.Rarity.UNCOMMON, "damage": 14, "up_damage": 21, "excluded": [CardData.CharacterRestriction.CONQUEROR]})
	...
	_make_card({"id": &"b01", "name": "ラム", "desc": "10ダメージ", "ap": 1, "fuel": 1, "tags": [CardData.Tag.BIKE], "damage": 10, "up_damage": 15, "excluded": [CardData.CharacterRestriction.CONQUEROR]})
	_make_card({"id": &"b02", "name": "サイドスワイプ", "desc": "6ダメージ+遅延", "ap": 1, "fuel": 1, "tags": [CardData.Tag.BIKE], "damage": 6, "up_damage": 9, "excluded": [CardData.CharacterRestriction.CONQUEROR]})
	_make_card({"id": &"d01", "name": "ガード", "desc": "5ブロック", "ap": 1, "tags": [CardData.Tag.DEFENSE], "block": 5, "up_block": 8})
	_make_card({"id": &"d02", "name": "ブレース", "desc": "12ブロック", "ap": 2, "tags": [CardData.Tag.DEFENSE], "block": 12, "up_block": 18})
	_make_card({"id": &"d03", "name": "回避ロール", "desc": "4ブロック+1ドロー", "ap": 1, "tags": [CardData.Tag.DEFENSE], "rarity": CardData.Rarity.UNCOMMON, "block": 4, "draw": 1, "up_block": 7})
	_make_card({"id": &"d08", "name": "応急処置", "desc": "HP6回復", "ap": 2, "tags": [CardData.Tag.DEFENSE], "rarity": CardData.Rarity.UNCOMMON})
	_make_card({"id": &"s01", "name": "アドレナリン", "desc": "2枚ドロー", "ap": 1, "tags": [CardData.Tag.SKILL], "rarity": CardData.Rarity.UNCOMMON, "draw": 2})
	_make_card({"id": &"s02", "name": "威圧", "desc": "萎縮2付与", "ap": 1, "tags": [CardData.Tag.SKILL], "damage": 0})
	_make_card({"id": &"s04", "name": "偵察", "desc": "デッキトップ3枚確認", "ap": 0, "tags": [CardData.Tag.SKILL]})
...
func _register_cultist_cards() -> void:
	...
	_make_card({"id": &"cu01", "name": "フルスロットル", "desc": "APコスト半減。自分に5ダメ+毒1", "ap": 0, "fuel": 3, "tags": [CardData.Tag.CHARACTER], "self_damage": 5, "starter": true, "restriction": CardData.CharacterRestriction.CULTIST})
	...
	_make_card({"id": &"cu03", "name": "聖なる炎", "desc": "10ダメージ", "ap": 1, "fuel": 1, "tags": [CardData.Tag.CHARACTER], "damage": 10, "up_damage": 15, "restriction": CardData.CharacterRestriction.CULTIST})
	...
	_make_card({"id": &"cu08", "name": "殉教", "desc": "自分に10ダメ。25ダメージ", "ap": 2, "tags": [CardData.Tag.CHARACTER], "rarity": CardData.Rarity.RARE, "damage": 25, "self_damage": 10, "up_damage": 38, "restriction": CardData.CharacterRestriction.CULTIST})
	_make_card({"id": &"cu10", "name": "アクセル全開", "desc": "+2AP。自分に3ダメ", "ap": 1, "fuel": 1, "tags": [CardData.Tag.CHARACTER], "self_damage": 3, "restriction": CardData.CharacterRestriction.CULTIST})
