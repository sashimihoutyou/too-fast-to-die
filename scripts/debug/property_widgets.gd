...
const PROPERTY_LABELS: Dictionary = {
	...
	"request_type": "希望種別 (request_type)",
	"request_nodes_min": "希望ノード数下限 (request_nodes_min)",
	"request_nodes_max": "希望ノード数上限 (request_nodes_max)",
	"request_site_types": "希望目的地施設 (request_site_types)",
	"request_line": "希望台詞 (request_line)",
	"settle_offer_line": "定着打診台詞 (settle_offer_line)",
	"fail_karma_penalty": "失敗カルマ (fail_karma_penalty)",
	"fail_fuel_penalty": "失敗燃料 (fail_fuel_penalty)",
	"fail_pursuit_penalty": "失敗追跡 (fail_pursuit_penalty)",
	"ending_fragment": "エンディング断片 (ending_fragment)",
	"settle_chance_percent": "定着基礎確率 (settle_chance_percent)",
